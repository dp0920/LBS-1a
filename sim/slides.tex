...
\vspace{0.5em}
\textbf{X-config CMA:} climbed cleanly to \textbf{best $\approx +680$} by gen 261 ($\sim$80\% of the mammalian gen-2500 winner at $\frac{1}{10}$ the compute). \emph{The X geometry is at least as optimizable as mammalian.}

\vspace{0.3em}
\textbf{X-config PPO:} same actuator-gap. Geometry doesn't fix the bang-bang trap --- that's an actuator-model problem, not a geometry problem.
\end{frame}
